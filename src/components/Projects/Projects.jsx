            ...
            <div className="container">
                ...
                <div className="project_row">
                    <div className="row g-4 justify-content-center wow animate__animated animate__slow 3s  animate__zoomInLeft">
                        ...
                        <div className="col-lg-4 col-md-6 ">
                            <div className="demo">
                                <figure className="imghvr-zoom-out-flip-horiz rounded"><img src={'https://play-lh.googleusercontent.com/VVJafiUEfuDVO7XJ2-d60eP7DoTH_tpDd4PxN8Fd4k3yD8L53XzdCCj-OGwB6RTCLhNXryxwCeVuE8VO7UbxVeY=w240-h240-rw'} alt="example-image" className="img-fuild" />
                                    <figcaption className="text-center">
                                        <h3>Sanchalan APP</h3>
